...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      try { setEntries(JSON.parse(saved)); } catch { /* ignore malformed data */ }
    }
  }, []);
  ...
  const isVisible = useCallback((entry: Entry) => {
    ...
    <>
      ...
      <div className="entries-list">
        {entries.map(entry => {
          ...
          return (
            ...
            >
              <div className="entry-text">&ldquo;{entry.bite}&rdquo;</div>
      ...
      <div className={`overlay ${selected ? "open" : ""}`}>
        ...
        <div className="overlay-panel">
          ...
          {selected && (
            <>
              <div className="overlay-bite">&ldquo;{selected.bite}&rdquo;</div>
              {selected.rest && (
                <>
